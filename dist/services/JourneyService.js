...
export async function addJourney(driverId, startDateTime, startLocation, endLocation, vehicleId, actualRoute, costAllocation, status, createdAt, updatedAt) {
    try {
...
export async function updateJourney(id, driverId, startDateTime, startLocation, endLocation, vehicleId, actualRoute, costAllocation, status, createdAt, updatedAt) {
